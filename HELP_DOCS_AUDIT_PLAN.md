...
- [ ] docs/types/3d/stl/metadata.js
- [ ] docs/types/3d/stl/renderer.js
- [ ] docs/types/3d/stl/settings.default.json
- [ ] docs/types/3d/stl/stllib.js
- [ ] docs/types/archive/detect.js
...
- [ ] docs/types/binary/arrow/renderer.js
- [ ] docs/types/binary/arrow/settings.default.json
