...
export const offlineModalJudgments = {
  ...
  'tablet-light-top': 'Tablet light top state centers the modal, fits all preset controls, and provides a clearly bounded scroll region above the sticky footer.',
  ...
  'desktop-light-top': 'Desktop light top state is compact and centered, with the toolbar, total, bundle list, scrollbar, and footer aligned without overflow.',
  'desktop-light-bottom': 'Desktop light bottom state shows the end of the bundle list and sticky footer while the backdrop and modal bounds remain clean.',
