...
import xsltStylesheet from '../types/text/known/xslt-stylesheet/index.js';
import svelteComponent from '../types/text/known/svelte-component/index.js';
import nunjucks from '../types/text/known/nunjucks/index.js';
import haskellLang from '../types/text/known/haskell-lang/index.js';
import zigLang from '../types/text/known/zig-lang/index.js';
...
import groovyLang from '../types/text/known/groovy-lang/index.js';
...
import tclLang from '../types/text/known/tcl-lang/index.js';
import schemeLang from '../types/text/known/scheme-lang/index.js';
import racketLang from '../types/text/known/racket-lang/index.js';
import fortranLang from '../types/text/known/fortran-lang/index.js';
import rubyLang from '../types/text/known/ruby-lang/index.js';
import perlLang from '../types/text/known/perl-lang/index.js';
import phpLang from '../types/text/known/php-lang/index.js';
import powershellLang from '../types/text/known/powershell-lang/index.js';
import solidityLang from '../types/text/known/solidity-lang/index.js';
import vhdlLang from '../types/text/known/vhdl-lang/index.js';
import arduinoSketch from '../types/text/known/arduino-sketch/index.js';
import cobolLang from '../types/text/known/cobol-lang/index.js';
import gleamLang from '../types/text/known/gleam-lang/index.js';
import odinLang from '../types/text/known/odin-lang/index.js';
import haxeLang from '../types/text/known/haxe-lang/index.js';
import adaLang from '../types/text/known/ada-lang/index.js';
import prologLang from '../types/text/known/prolog-lang/index.js';
...
import ponyLang from '../types/text/known/pony-lang/index.js';
...
import typstDoc from '../types/text/known/typst-doc/index.js';
...
import forthLang from '../types/text/known/forth-lang/index.js';
...
import aptSources from '../types/text/known/apt-sources/index.js';
import pkgbuild from '../types/text/known/pkgbuild/index.js';
import limitsConf from '../types/text/known/limits-conf/index.js';
import auditRules from '../types/text/known/audit-rules/index.js';
import commonLisp from '../types/text/known/common-lisp/index.js';
import emacsLisp from '../types/text/known/emacs-lisp/index.js';
import squirrelLang from '../types/text/known/squirrel-lang/index.js';
import redLang from '../types/text/known/red-lang/index.js';
import journaldConf from '../types/text/known/journald-conf/index.js';
import tmpfilesD from '../types/text/known/tmpfiles-d/index.js';
import nsswitchConf from '../types/text/known/nsswitch-conf/index.js';
import mkinitcpioConf from '../types/text/known/mkinitcpio-conf/index.js';
import wpaSupplicantConf from '../types/text/known/wpa-supplicant-conf/index.js';
