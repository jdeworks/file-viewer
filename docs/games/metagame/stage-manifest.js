// stage-manifest.js — the lightweight, always-loaded index of all 9 metagame stages.
//
...
// code instead of all nine stages up front.
//
...
// traverses all nine stages, so any drift fails the smoke automatically.
//
...
// entirely (playtesters found it too hard to understand/use); Observer State moved 9→8, and Awakening
// (the finale) moved 10→9. See docs/games/metagame/stages/stage9/crossstage.js for how the finale's
// content adjusted (it lost one of its nine prior-stage memories, dropping to eight).
