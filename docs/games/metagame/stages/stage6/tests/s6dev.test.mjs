// s6dev.test.mjs — unit tests for Stage 6 dev-menu cheat mutators.
//
// Covers each pure function in s6dev.js: devHeal, devGrantKeys, devAddCards, devSkipToBoss,
...
console.log("stage6 s6dev tests passed");
