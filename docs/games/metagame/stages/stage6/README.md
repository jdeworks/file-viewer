# Stage 6 — Protocol Codex

**Genre:** roguelike **deck-builder** (Slay-the-Spire-style). **Theme:** something on
the far end is answering — not clearly, but answering. Build a deck to negotiate with it.
...
- **Click** a map node to move; **click** a card to play it (drag onto a target where
  prompted); **click End Turn**, potions, and reward choices.
