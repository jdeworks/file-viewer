...
export const REQUIRED_ACTION = "9.offline_mode_activated";
export const ACHIEVEMENT_ID = "stage9.offline_mode_activated";
export const ACHIEVEMENT_TEXT = "I learned the shape of the silence.";
export const BTS_PATH = "/docs/bts/observer_state.bts";
export const NOTES_PATH = "/docs/examples/metagame/stage9/service-worker-notes.txt";
