export const STAGE_ID = 9;
export const ACTION_NAME = "memory_resolved";
export const REQUIRED_ACTION = "9.memory_resolved";
export const BTS_PATH = "/docs/bts/awakening.bts";

// 8 prior-stage memories, not 9 (Entropy Field/old-stage-8 was removed from the game entirely; see
// crossstage.js). memoryRoute/capstoneIntegrated/echoThresholds.understand/.total all meant "ALL of
// them" and must track the new total. finalQuestion/enrichedResponse/expand are intermediate
// thresholds (not "all") — their absolute values are unchanged, still sensible against a total of 8.
