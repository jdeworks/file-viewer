// testhook.js — Stage 9 Observer State: the window.__fvStage9 smoke/debug hook (no player affordance).
...
export function installTestHook(api) {
  ...
  return () => { if (window.__fvStage9 === hook) delete window.__fvStage9; };
}
