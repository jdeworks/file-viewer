// Single source of truth for Stage 9 echo VERBS — the DISTINCT real app action that witnesses each
// memory's echo. This is the core of Stage 9's "the host app IS the game" design: a finale that
// explicitly exercises the specific viewer skills the player learned across stages 1–8, rather than
// collapsing all eight echoes into identical text-file opens.
//
...
// <id>_echo-named text file that stage9EchoMemoryId could parse.
