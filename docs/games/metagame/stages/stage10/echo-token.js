...
//
// Opening a memory's real artifact in the viewer fires echo_<id> (viewer-actions.recordStage10Echo-
// Open). To stop a trivial console spoof — `setAction(10, 'echo_genesis', {})` — from forging that
// signal, the REAL open stamps the memory's token into the action detail; the Stage-10 subscription
