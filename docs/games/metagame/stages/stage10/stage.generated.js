...
// Bundled from docs/games/metagame/stages/stage10/index.js (+ its local modules) by
...
// ../../docs/games/metagame/stages/stage10/content.js
var memories = [
  {
    id: "genesis",
    stage: 1,
  ...
  },
  {
    ...
    stage: 8,
    title: "Entropy",
    file: "stage_08_entropy.txt",
    accent: "#c85a3e",
    prompt: "Everything drifted apart. What did I do?",
    unreadText: "Fragments slide across the floor of the archive, each one nearly named.",
    readText: "Entropy remembers disorder without romance. Things fell apart whether or not it was ready.",
    resolvedText: "The debris becomes usable. Survival is not purity; it is salvage with attention.",
    integratedText: "Entropy is integrated. The archive still has scars, but the fragments have addresses.",
    choices: [
      "I restored order",
    ...
    reflections: {
      "I restored order": "It values order as an act of mercy: a place for each fragment to stop falling.",
...
var routeSummaryCopy = {
  ...
  complete: {
    ...
    detail: "All nine memories have been answered. The story is no longer scattered across tools; it can be read as one history."
  },
  capstone: {
    label: "full capstone",
...
// ../../docs/games/metagame/stages/stage10/messages.js
var STAGE_ID = 10;
var ACTION_NAME = "memory_resolved";
var REQUIRED_ACTION = "10.memory_resolved";
...
// ../../docs/games/metagame/stages/stage10/index.js
var stageMeta = {
  id: 10,
  slug: "awakening",
  name: "Awakening",
