...
export function calcRoundPackets({ roundId, onBeatPct = 0, integrityRemaining = 0, gatesCollected = 0, gateValue = 5, upgrades, multiplier = 1 }) {
  ...
  // gateValue comes from the vehicle shop's Signal Amp tuning; the legacy `upgrades.signalAmplifier`
  // boolean is still honoured so older callers/saves keep working.
