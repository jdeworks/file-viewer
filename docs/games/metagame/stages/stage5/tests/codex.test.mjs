...
const fixturePath = resolve(here, "../../../../../examples/metagame/stage5/protocols_of_the_entity.epub");

{
  ...
  assert.deepEqual(actionCalls[0], [
    5,
    "protocol_ch9_read",
    { source: "stage5-codex", file: EPUB_PATH, chapter: 9 }
  ]);
  assert.equal(viewerCalls[0][0], EPUB_PATH);
  assert.equal(viewerCalls[0][1].source, "stage5");
...
console.log("stage5 codex tests passed");
