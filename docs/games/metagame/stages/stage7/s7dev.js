...
//
// CONTROLS
//   skip-case1       Fast-forward SS1–SS4 (Credential Scan → Dup → Timeline → Chain) → land at
//                    Case 2 accusation (substage 5). Sets all upstream satisfied flags.
...
// applyExifContradictionUnlock performs (minus DOM bell/achievement side-effects that require a
