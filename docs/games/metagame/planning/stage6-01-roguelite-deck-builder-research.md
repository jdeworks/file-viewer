# Stage 6 — 01: Roguelite Deck Builder Genre Research

Reference research for the **Protocol Codex** Stage 6 design. Developer-facing distillation
...
`stage6-02-our-game-design.md` maps this onto our Stage 6 implementation.
...
**Our Stage 6:** starts at **2 energy** (tighter than StS; forces harder choices early).
...
**Our Stage 6 map:** 3 acts × 15 nodes each = 45 nodes per run. Acts map to:
...
**Our Stage 6 boss:** The Refused Connection — three-phase boss that changes protocol mid-fight,
...
Stage 6 is intentionally the *longest* single-genre game in the Defragmenter series.
...
## G. How this maps to Stage 6: Protocol Codex (pointer)

Stage 6 takes **Slay the Spire's** run structure and energy system, **Inscryption's** narrative
...
as a discoverable guide to the full combo table. Full spec in `stage6-02-our-game-design.md`.
