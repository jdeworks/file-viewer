...
export async function render(intake, _ctx) {
  ...
  const styles = `<style>
    ...
    @media(max-width:520px){
      ...
      .midi-table td{display:grid;grid-template-columns:112px minmax(0,1fr);gap:8px;border-bottom:1px solid #e2e8f0;overflow-wrap:anywhere;white-space:normal}
      .midi-table td:last-child{border-bottom:0}.midi-table td::before{content:attr(data-label);font-weight:600;color:#5a6678;white-space:normal;overflow-wrap:normal;word-break:normal;line-height:1.25}
