...
export function mountMeshView(model, infoText) {
  ...
  host.querySelector('.stl-dl-obj').addEventListener('click', () => {
    ...
    const [r, g, b] = overrideColor ? overrideColor : [0.286, 0.471, 0.784];
    const mtl = 'newmtl mesh_color\nKd ' + r.toFixed(4) + ' ' + g.toFixed(4) + ' ' + b.toFixed(4) + '\n';
    const objLines = ['# Generated by file-viewer', 'mtllib ' + base + '-colored.mtl', 'usemtl mesh_color'];
